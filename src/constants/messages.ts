...
export const PROJECTS_MESSAGES = {
    ...
    GET_PARTICIPANT_ATTACHMENTS_SUCCESSFULLY: 'Get participant attachments successfully',
    GET_PARTICIPANT_ATTACHMENT_SUCCESSFULLY: 'Get participant attachment successfully',
    GET_PARTICIPANT_COMMENTS_SUCCESSFULLY: 'Get participant comments successfully',
    GET_PARTICIPANT_COMMENT_SUCCESSFULLY: 'Get participant comment successfully',
    GET_PARTICIPANT_PARTICIPANTS_SUCCESSFULLY: 'Get participant participants successfully',
    GET_PARTICIPANT_PARTICIPANT_SUCCESSFULLY: 'Get participant participant successfully',
    GET_PARTICIPANT_PROJECTS_SUCCESSFULLY: 'Get participant projects successfully',
